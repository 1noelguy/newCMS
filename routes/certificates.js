...
router.post(
  ...
  async (req, res, next) => {
    ...
    const query = `INSERT INTO certificates (userEmail,projectTitle,projectPurpose,revGen,externalUsers,requestType,managerApproval,csrLink,domainName,dnsMappingReq,degEffect,confluenceLink,serverAddress,operatingSystem,portNumber,status ,serverSpecs,dateRequested,serverHostname) VALUES (${db.escape(req.body.userEmail)},${db.escape(req.body.projectTitle)},${db.escape(req.body.projectPurpose)},${db.escape(req.body.revGen)},${db.escape(req.body.externalUsers)},${db.escape(req.body.requestType)},${db.escape(req.body.managerApproval)},${db.escape(req.body.csrLink)},${db.escape(req.body.domainName)},${db.escape(req.body.dnsMappingReq)},${db.escape(req.body.degEffect)},${db.escape(req.body.confluenceLink)},${db.escape(req.body.serverAddress)},${db.escape(req.body.operatingSystem)},${db.escape(req.body.portNumber)},${db.escape(req.body.status)},${db.escape(req.body.serverSpecs)},${db.escape(req.body.dateRequested)},${db.escape(req.body.serverHostname)})`;
